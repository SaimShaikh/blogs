                ...
                <div className="grid lg:grid-cols-[280px,1fr] gap-12 lg:gap-24">
                    ...
                    <article className="max-w-3xl font-sans">
                        ...
                        >
                            ...
                            <div className="text-brand-text/80 leading-relaxed text-lg lg:text-xl
                                [&_h3]:text-2xl [&_h3]:font-bold [&_h3]:text-brand-text [&_h3]:mt-16 [&_h3]:mb-4 [&_h3]:font-mono
                                [&_p]:mb-6
                                [&_ul]:space-y-4 [&_ul]:mb-8 [&_ul]:list-none [&_ul]:pl-2
                                [&_li]:flex [&_li]:items-start [&_li]:gap-3
                                [&_li::before]:content-['>'] [&_li::before]:text-brand-primary [&_li::before]:font-mono [&_li::before]:font-bold [&_li::before]:mt-1
