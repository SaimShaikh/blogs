    ...
    <>
      ...
      <section className="mt-8 grid gap-6 md:grid-cols-2 xl:grid-cols-3">
        {filteredPosts.map((post) => (
          <article key={post.slug} className="group overflow-hidden rounded-2xl border border-card-border bg-card transition-all hover:border-brand-primary/40 hover:-translate-y-1">
            {post.image && (
              <div className="aspect-video w-full overflow-hidden border-b border-card-border bg-background/50">
