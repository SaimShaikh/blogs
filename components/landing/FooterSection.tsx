                ...
                <div className="grid grid-cols-1 gap-12 md:grid-cols-4 lg:gap-16">
                    ...
                    <div>
                        ...
                        <ul className="space-y-3 text-sm text-brand-text/60">
                            <li>
                                <FooterLink href="/post" label="Latest Posts" />
                            </li>
                            <li>
                                <FooterLink href="/post" label="Editorial Index" />
                            </li>
                            <li>
                                <FooterLink href="https://www.edgeopslabs.com/products" label="EdgeOps Products" external />
                            </li>
                            <li>
